...
const Schema = new mongoose.Schema({
    ...
    nftCode: { type: String },
    propertyStatus: { type: String, enum: [constants.PROPERTY_STATUS.AVAILABLE, constants.PROPERTY_STATUS.AUCTIONED, constants.PROPERTY_STATUS.KILLED], default: constants.PROPERTY_STATUS.AVAILABLE },
