...
const Schema = new mongoose.Schema({
    ...
    propertyCategory: { type: String, enum: [constants.PROPERTY_STATUS.MONUMENT, constants.PROPERTY_STATUS.HOT_PROPERTY], default: "" },
    propertyLatitude: { type: String },
    propertyLongitude: { type: String },
    propertyAddress: { type: String },
    nftCode: { type: String },
    propertyStatus: { type: String, enum: [constants.PROPERTY_STATUS.AVAILABLE, constants.PROPERTY_STATUS.AUCTIONED, constants.PROPERTY_STATUS.KILLED, constants.PROPERTY_STATUS.SOLD], default: constants.PROPERTY_STATUS.AVAILABLE },
    ...
    propertyOwner: { type: mongoose.Types.ObjectId },
    propertyBoughtAmount: { type: Number  },
    isOpenToSale: { type: String, enum: ["YES", "NO"], default: "YES" },
    propertySaleStartOn: { type: Number },
    propertySoldOn: { type: Number },
    hexID: { type: String },
